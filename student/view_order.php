...
<?php
$sql="select * from booking,menu where booking.menu_id=menu.menu_id and booking.cust_id='$log' and booking.p_status='booked'";
                  ...
                  <tr>
                    ...
                    <td class="product-name">
                     ...
                     if($data['p_status']=='booked'){
                      $b=$data['book_id'];
                      $str="select * from feedback where book_id=$b and cust_id='$log'";
